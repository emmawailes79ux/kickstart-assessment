...
router.post('/manage-placements/v02/manage/cancel-placement-dw', function (req, res) {
  const editChoice = req.session.data['cancel-placement']
  if (editChoice === 'cancel-yes') {
    res.redirect('/manage-placements/v02/manage/placement-cancel-dw')
  } else if (editChoice === 'cancel-no') {
    res.redirect('/manage-placements/v02/manage/placements-updated')
  }
});
...
router.post('/employer/pb-v2-closedown-v3/kc-choose', function (req, res) {
  const editChoice = req.session.data['2fa-choose']

  if (editChoice === 'authenticator-app') {
    res.redirect('/employer/pb-v2-closedown-v3/kc-2fa')
  } else if (editChoice === 'mobile-phone') {
    res.redirect('/employer/pb-v2-closedown-v3/kc-phone')
  }
});
...
router.post('/employer/mvp-v2/kc-choose', function (req, res) {
  const editChoice = req.session.data['2fa-choose']

  if (editChoice === 'authenticator-app') {
    res.redirect('/employer/mvp-v2/kc-2fa')
  } else if (editChoice === 'mobile-phone') {
    res.redirect('/employer/mvp-v2/kc-phone')
  }
});
