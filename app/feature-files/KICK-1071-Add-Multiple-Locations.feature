Feature: Add Multiple Locations

Description: As an employer, I need to enter details about my vacancy's
multiple locations, so that I can reach the right claimants for a vacancy
...
- Locations: the locations in which the vacancy will be advertised
...
- Next page is Hours and Pay [KICK-906]
...
Scenario: User clicks the "Add Another Location" button
  Given that I am a User who clicks the "Add Another Location" button
  When I click "Continue"
  Then the system must create another set of form fields for another Location object

# Duplication

Scenario: User enters the same location twice or more
  Given that I am a User who enters the same location twice or more
  When I click "Continue"
...
Scenario: User clicks "Continue" after filling out all the form fields properly
  Given that I am a User providing details about my vacancies' hours and pay
